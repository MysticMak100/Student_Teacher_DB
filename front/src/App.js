    ...
    <div>
      <Router>
        <Routes>
          <Route
            path="/"
            element={auth ? <Navigate to="/home" /> : <Front />}
          />
          <Route
            path="/home"
          ...
          <Route
            path="/login"
            element={auth ? <Navigate to="/home" /> : <LoginPage />}
          />
          <Route path="/logout" element={<Navigate to="/login" />} />
          <Route
            path="/register"
            element={auth ? <Navigate to="/home" /> : <SignUpPage />}
          />
          <Route
            path="/students"
            element={auth ? <StudentDB /> : <Navigate to="/login" />}
          />
          <Route
            path="/teachers"
            element={auth ? <TeacherDB /> : <Navigate to="/login" />}
          />
          <Route
            path="/add_teacher"
            element={auth ? <AddTeacher /> : <Navigate to="/login" />}
          />
          <Route
            path="/add_student"
          ...
          <Route
            ...
            element={auth ? <EditStudent /> : <Navigate to="/login" />}
          />
          <Route
            path="/teacher/edit/:id"
            element={auth ? <EditTeacher /> : <Navigate to="/login" />}
          />
        </Routes>
      </Router>
    </div>
